...
async def start(_, msg):
    buttons = [
        [
                InlineKeyboardButton("𝗦𝗨𝗣𝗣𝗢𝗥𝗧", url="https://t.me/BOT_SUPPORT_GROUP7"),
                InlineKeyboardButton("𝗨𝗣𝗗𝗔𝗧𝗘", url="https://t.me/ll_BOTCHAMBER_ll")
        ],
        [ 
...
async def repo(_, message):
    ...
    if response.status_code == 200:
        ...
        text = f"""[𝖱𝖤𝖯𝖮 𝖫𝖨𝖭𝖪](https://t.me/ll_BOTCHAMBER_ll) | [𝖦𝖱𝖮𝖴𝖯](https://t.me/BOT_SUPPORT_GROUP7)
| 𝖢𝖮𝖭𝖳𝖱𝖨𝖡𝖴𝖳𝖮𝖱𝖲 |
----------------
{list_of_users}"""
